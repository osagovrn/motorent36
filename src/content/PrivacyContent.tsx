...
export function PrivacyContent({ locale, dict }: Props) {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <h1 className="font-display mt-4 text-3xl font-extrabold text-amber-50 sm:text-4xl">
        {dict.legal.privacyPageTitle}
      </h1>
      <p className="mt-2 text-sm text-zinc-500">
        {SEO_CONFIG.brandName} · {LEGAL_CONFIG.privacyRevision}
      </p>
      ...
      <div className="space-y-4 text-sm leading-relaxed text-zinc-300">
        ...
        <p>
          ...
          <Link href={localePath(locale, "/offer/")} className="text-amber-400 hover:underline">
            {dict.legal.offerPageTitle}
          </Link>
          .
        </p>
