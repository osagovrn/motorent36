      ...
      <div className="mt-8 space-y-5 text-sm leading-relaxed text-zinc-300">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            Акцепт оферты: обращение по телефону, в Telegram или MAX с
            подтверждением условий проката и последующее получение имущества на
            согласованной встрече {SEO_CONFIG.cityInFormat} с оформлением акта
            приёма-передачи. Онлайн-заявок и оплаты на сайте нет.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            Обращаясь по телефону, в Telegram или MAX, вы соглашаетесь на
            обработку персональных данных (имя, телефон, сведения о
            бронировании), которые вы сообщаете для связи, исполнения договора и
